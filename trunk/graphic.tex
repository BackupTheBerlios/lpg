...
maksymaln± liczb± wspieran± przez terminal, oraz {\it COLOR\_PAIR} - maksymalna
...
max\_colors                & {\tt colors}  & {\tt Co} &    maksymalna liczba kolorów na ekranie\\
max\_micro\_address        & {\tt maddr}   & {\tt Yd} &    maksymalna liczba w micro\_...\_address\\
max\_micro\_jump           & {\tt mjump}   & {\tt Ye} &    maksymalna liczba w parm\_...\_micro\\
max\_pairs                 & {\tt pairs}   & {\tt pa} &    maksymalna liczba color-pairs na ekranie\\
...
max\_attributes            & {\tt ma}      & {\tt ma} &  maksymalna liczba po³±czonych atrybutów, które terminal obs³u¿y \\
maximum\_windows           & {\tt wnum}    & {\tt MW} &  maksymalna liczba okien do zdefiniowania\\
