...
\chapter{\label{mdw}Przenoszenie aplikacji do Linuxa}
\author{Matt Welsh \\ {\tt mdw@cs.cornell.edu}}
\date{26 Stycznia 1995}

\section{Wstêp}

Przenoszenie aplikacji Unix do Linuxa jest dosyæ ³atwe. Linux i biblioteka 
...
{\em select\/} jest zmniejszany podczas dzia³ania przez Linuxa. 
Inne implementacje nie zmieniaj± tej warto¶ci, a aplikacje, które nie spodziewaj±
siê takiego dzia³ania mog± siê za³amaæ po przeniesienu na Linuxa.
...
przenoszeniem aplikacji pod Linuxa, podkre¶laj±c róznice miêdzy Linuxem, POSIX.1 oraz 
...
\subsection{Sygna³y obs³ugiwane przez Linuxa}
...
{\em /proc} z SVR4 znacznie ró¿ni siê od tego z Linuxa i nie powinno ich siê
...
Je¿eli musisz zmodyfikowaæ istniej±cy kod w celu przeniesienia go do Linuxa
mo¿esz u¿yæ parê {\tt ifdef}\ldots {\tt endif} aby wyodrêbniæ specyficzne dla
Linuxa czê¶ci, lub kod odpowiadaj±cy innym systemom. Czê¶æ programów u¿ywa
pewnych konwencji co do oddzielania kodu definicjami: {\tt SVR4} dla kodu
pod System V, {\tt BSD} dla kodu BSD i {\tt linux} dla kodu pod Linuxa.

Biblioteka GNU C u¿ywana przez Linuxa pozwala ci na w³±czenie ró¿nych opcji
...
\begin{verbatim}
  #ifdef linux
\end{verbatim} 
aby wyodrêbniæ kod pod Linuxa. U¿ywaj±c tych makr mo¿esz ³atwo zaadaptowaæ
